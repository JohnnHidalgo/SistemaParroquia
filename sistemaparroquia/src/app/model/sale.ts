...
export class CreateSale {
    constructor(public personname: String,public totalprice: Number,public comentary: String,public datesale: String,public tx_user:String,public tx_date:any,public active:boolean) {}
}